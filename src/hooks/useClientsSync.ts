    ...
    const fetchClients = async () => {
      ...
      try {
        ...
        const clientsWithDates = data.map((client: any) => ({
          ...
          reserveBalance: parseFloat(client.reserve_balance) || 0,
          reserveTransactions: client.reserveTransactions || [],
          ...
          projects: (client.projects || []).map((p: any) => ({
            ...
            hourly_rate: p.hourly_rate !== undefined && p.hourly_rate !== null
              ...
              : undefined,
            studio_hourly_rate: p.studio_hourly_rate !== undefined && p.studio_hourly_rate !== null
              ? parseFloat(String(p.studio_hourly_rate))
              : undefined,
