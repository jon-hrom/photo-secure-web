    ...
    items: [
      {
        ...
        answer: 'Вы можете войти через Email, VK ID или Яндекс. Для Email потребуется подтверждение почты. После входа вы попадёте на главную страницу с статистикой.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Проверьте правильность email и пароля. Используйте "Забыли пароль?" для восстановления. Если входили через VK или Яндекс, используйте тот же способ входа.',
      },
      {
