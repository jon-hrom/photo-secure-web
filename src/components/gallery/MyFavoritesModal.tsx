    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-2 sm:p-4" onClick={onClose}>
      ...
      >
        ...
        {!isLoading && !error && displayPhotos.length > 0 && (coverSelectEnabled || vignetteSelectEnabled) && (
          <MyFavoritesSelectionBar
            isDarkTheme={isDarkTheme}
            selectionMode={selectionMode}
            pendingSelection={pendingSelection}
            savingMarker={savingMarker}
            coverPhotoId={coverPhotoId}
            vignettePhotoId={vignettePhotoId}
            coverSelectEnabled={coverSelectEnabled}
            vignetteSelectEnabled={vignetteSelectEnabled}
