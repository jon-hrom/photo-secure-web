    ...
    <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
      ...
      <div className="space-y-5 text-sm leading-relaxed">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Выберите тип <strong>«Моя страница»</strong> — прямо в форме появится синяя кнопка
            «Открыть страницу получения токена». Нажмите её, разрешите доступ, а затем скопируйте
            весь адрес из адресной строки браузера и вставьте в поле «Токен». ID указывать не нужно.
          </p>
          <p className="text-muted-foreground">
            Токен даёт доступ только к отправке сообщений — пароль от вашей страницы мы не видим.
          </p>
        </div>
