      ...
      <div className="grid grid-cols-3 gap-2">
              ...
              {isTechRejectsFolder ? (
                <>
                  <Button 
                    ...
                    className="aspect-square h-auto flex flex-col items-center justify-center gap-1.5 p-3 bg-gradient-to-r from-purple-50 to-violet-50 hover:from-purple-100 hover:to-violet-100 border-purple-200 text-purple-900 hover:text-purple-950"
                  >
          ...
          {onShowAllChats && !selectedFolder && (
            <Button 
              ...
              className="aspect-square h-auto flex flex-col items-center justify-center gap-1.5 p-3 bg-gradient-to-r from-purple-50 to-violet-50 hover:from-purple-100 hover:to-violet-100 border-purple-200 text-purple-900 hover:text-purple-950 relative"
            >
