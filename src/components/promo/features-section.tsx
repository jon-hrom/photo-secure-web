...
const features = [
  ...
  },
  {
    ...
    description:
      "Съёмки, выезды и свободные окна на одной сетке. Foto-Mix сам подсветит накладки и подскажет, влезает ли дорога между двумя адресами.",
    icon: "CalendarDays",
    tag: "02",
  },
  {
  ...
  },
  {
    ...
    description:
      "Предоплата, остаток, допы за дополнительные кадры. Видно, кто ещё не заплатил, и сколько вы заработали за месяц и за сезон.",
    icon: "Wallet",
    tag: "05",
  },
  {
    title: "Статистика съёмок",
    description:
