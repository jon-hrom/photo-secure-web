...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Статистика по месяцам и форматам съёмок",
    ],
  ...
  },
  {
    ...
    monthly: 2400,
    yearly: 1900,
    caption: "Для плотного графика",
    features: [
      "Всё из «Практики»",
      "Помощник или ретушёр в вашем аккаунте",
      "Расширенное хранилище под архив съёмок",
      "Портфолио на личной ссылке",
