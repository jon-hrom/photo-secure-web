...
const tabs: Tab[] = [
  {
    ...
    bullets: [
      "История съёмок и отмеченные клиентом кадры",
      "Заметки: свет, ракурсы, чего просили избегать",
      "Дни рождения — повод написать первым",
    ],
    panel: {
  ...
  },
  {
    ...
    text: "Съёмки, выезды и встречи на одной сетке — списком, таблицей или календарём. Новую съёмку можно завести голосом, прямо по дороге.",
    bullets: [
      "Голосовое создание съёмки за полминуты",
      "Три вида: список, таблица и календарь",
      "Встречи с клиентами отдельно от съёмок",
    ],
    panel: {
  ...
  },
  {
    ...
    bullets: [
      "За сутки, за пять часов и за час до съёмки",
      "Почта, Telegram, WhatsApp и push в браузере",
      "Поздравления клиентам с днём рождения",
    ],
    panel: {
  ...
  },
  {
    ...
    label: "Обработка",
    icon: "Wand2",
    headline: "Ретушь идёт, а вы работаете дальше",
    text: "Обработайте один кадр или запустите всю папку разом. Прогресс виден в плавающей панели — можно свернуть её и спокойно заниматься другими съёмками.",
    bullets: [
      "Одиночная ретушь кадра или всей папки сразу",
      "Очередь задач с прогрессом в плавающей панели",
      "Удаление логотипов и восстановление старых снимков",
    ],
    panel: {
      caption: "Очередь обработки",
      rows: [
        { primary: "Лавстори · Мария К.", secondary: "12 из 20 кадров готовы", badge: "В работе" },
        { primary: "Предметка · Ирина Г.", secondary: "Вся папка, 40 кадров", badge: "В очереди" },
        { primary: "Портфолио · Артём С.", secondary: "Логотипы убраны, 18 кадров", badge: "Готово" },
      ],
    },
  },
  {
    ...
    label: "Галерея",
    icon: "Images",
    headline: "Клиент получает ссылку, а не архив в мессенджере",
    text: "Личная галерея с паролем и вашим логотипом. Заказчик отмечает избранное, качает архивом или к себе на Яндекс.Диск и пишет вам прямо оттуда.",
    bullets: [
      "Пароль на галерею и защита от скриншотов",
      "Скачивание одним архивом или на Яндекс.Диск",
      "Видно, сколько раз галерею открывали",
    ],
    panel: {
      caption: "Отданные галереи",
      rows: [
        { primary: "Мария К. — лавстори", secondary: "48 кадров · 12 просмотров", badge: "Открыта" },
        { primary: "Артём С. — портфолио", secondary: "18 кадров · отобрано 9", badge: "Отбор" },
        { primary: "Ирина Г. — предметка", secondary: "40 кадров · скачано архивом", badge: "Сдано" },
      ],
    },
  },
]
      ...
      <div className="max-w-7xl mx-auto" ref={ref}>
        <div className="max-w-3xl mb-14">
          ...
          <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-bold text-card-foreground leading-[1.08]">
            Пять экранов, в которых <span className="italic text-primary">живёт ваша работа</span>
          </h2>
        </div>
