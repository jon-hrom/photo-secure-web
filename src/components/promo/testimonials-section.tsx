...
const testimonials = [
  ...
  {
    name: "Ирина Гладкова",
    role: "Предметный фотограф, Екатеринбург",
    avatar: "/asian-woman-tech-developer.jpg",
    content:
      "Веду по три-четыре съёмки в неделю и наконец вижу картину целиком. Статистика показала, что половину выручки приносит один формат — стали брать его чаще.",
  },
]
