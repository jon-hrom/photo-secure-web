...
const faqs = [
  ...
  {
    question: "Можно ли работать студией из нескольких фотографов?",
    answer:
      "Да, на тарифе «Студия». Общий календарь, распределение съёмок между фотографами и ретушёрами, отдельные отчёты по каждому. Клиентская база при этом остаётся общей, а доступы настраиваются по ролям.",
  },
  {
