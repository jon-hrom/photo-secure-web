    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <Card>
          <CardHeader className="pb-2 sm:pb-3">
            <CardTitle className="text-xs sm:text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">Общий бюджет</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2 sm:pb-3">
            <CardTitle className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white flex items-center gap-2">Оплачено с учетом аванса</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="sm:col-span-2 lg:col-span-1">
          <CardHeader className="pb-2 sm:pb-3">
            <CardTitle className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white flex items-center gap-2">Остаток суммы за все услуги</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-black dark:text-white">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 pb-20">
          ...
          {comments.length === 0 ? (
            <p className="text-center text-muted-foreground dark:text-gray-300 py-4">
