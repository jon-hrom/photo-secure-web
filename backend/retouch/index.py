...
DEFAULT_PIPELINE = [
    {"op": "blackheads", "strength": 1.0, "thr_q": 94, "thr_min": 10, "max_area": 600, "dilate_spots": 1, "inpaint_radius": 3, "mask": {"max_det_side": 3000, "dilate_px": 6, "blur_sigma": 1.0, "skin_erode_px": 10}, "exclude": {"exclude_nose": True}, "mask_only": True},
    {"op": "lama_inpaint", "dilate": 1, "blur": 1.2, "use_exclude": True}
]
