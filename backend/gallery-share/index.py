...
def handler(event: dict, context) -> dict:
    ...
    try:
        ...
        if method == 'POST':
            ...
            request_review = data.get('request_review', True)
            ...
            grid_size = data.get('grid_size', 280)
            ...
            if existing_link:
                ...
                cur.execute(
                    ...
                    SET expires_at = %s, password_hash = %s, download_disabled = %s,
                        ...
                        cover_focus_x = %s, cover_focus_y = %s, grid_gap = %s, grid_size = %s,
                    ...
                    (expires_at, password_hash, download_disabled,
                     ...
                     cover_focus_x, cover_focus_y, grid_gap, grid_size,
                     ...
                     cover_select_enabled, vignette_select_enabled, request_review, short_code)
                )
            else:
                ...
                cur.execute(
                    ...
                    (short_code, folder_id, user_id, expires_at, password_hash, download_disabled,
                     ...
                     cover_photo_id, cover_orientation, cover_focus_x, cover_focus_y, grid_gap, grid_size,
                     bg_theme, bg_color, bg_image_url, text_color, cover_text_position,
                     cover_title, cover_font_size,
                     mobile_cover_photo_id, mobile_cover_focus_x, mobile_cover_focus_y,
                     client_upload_enabled, client_folders_visibility,
                     cover_select_enabled, vignette_select_enabled, request_review)
                    ...
                    if not subfolder_id:
                        cur.execute(
                            ...
                            SELECT fsl.short_code, fsl.expires_at, fsl.download_disabled,
                                   ...
                                   COALESCE(fsl.request_review, TRUE) as request_review
            ...
            (folder_id, expires_at, folder_name, password_hash, download_disabled,
             ...
             cover_select_enabled, vignette_select_enabled, request_review) = result
            ...
            return {
                ...
                'body': json.dumps({
                    ...
                    'grid_size': grid_size if grid_size is not None else 280,
